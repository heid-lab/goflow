...
uv run flow_train.py -m model.num_steps=1,3,5,10,25,50 model.num_samples=25 task_name=test_ablate_steps train=False custom_model_weight_path=$MODEL_PATH
