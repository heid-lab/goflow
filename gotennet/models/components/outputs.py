...
from gotennet.models.components.ops import (Dense, ScaleShift, GetItem, SchnetMLP, shifted_softplus, str2act,
...
# TODO: modify to accept r/ts/p
class Atomwise3DOutRTSP(nn.Module):
    """
