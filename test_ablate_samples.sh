...
python flow_train.py -m model.num_samples=1,3,5,10,25,50 model.num_steps=25 task_name=test_ablate_samples train=False custom_model_weight_path=$MODEL_PATH
